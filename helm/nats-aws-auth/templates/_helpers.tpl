...
Common labels
*/}}
{{- define "nats-aws-auth.labels" -}}
helm.sh/chart: {{ include "nats-aws-auth.chart" . }}
{{ include "nats-aws-auth.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "nats-aws-auth.selectorLabels" -}}
